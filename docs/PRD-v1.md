...
- Development instance: `http://10.0.1.9:3001`, Invidious `2026.08.04`. Plain HTTP on LAN.
...
- Instance URL (default `http://10.0.1.9:3001`), validated by calling `/api/v1/stats`.

...
struct StoreTests {
    ...
    @Test func profileStoreRoundTrips() {
        ...
        let profile = Profile(name: "Ada Lovelace", username: "ada", instanceURL: URL(string: "http://192.168.1.10:3000")!, colorIndex: 2, createdAt: Date(timeIntervalSince1970: 1_700_000_000))
        store.add(profile)
    ...
    @Test func resumeSyncsBetweenDevicesByAccount() {
        ...
        let key = ResumeStore.accountKey(instanceURL: URL(string: "http://192.168.1.10:3000")!, username: "Ada")
        #expect(key == ResumeStore.accountKey(instanceURL: URL(string: "HTTP://192.168.1.10:3000/")!, username: "ada"))
        ...
        other.setAccountKey(ResumeStore.accountKey(instanceURL: URL(string: "http://192.168.1.10:3000")!, username: "someone"), for: otherProfile)

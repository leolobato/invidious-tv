...
struct ClientTests {
    ...
    @Test func resolvesRelativeAndAbsoluteURLs() throws {
        #expect(try client.absoluteURL("/vi/abc/maxres.jpg").absoluteString == "http://10.0.1.9:3001/vi/abc/maxres.jpg")
    ...
    @Test func formEncodesCredentials() {
        let body = InvidiousClient.formEncode([("email", "leo lobato"), ("password", "a&b=c")])
        #expect(String(decoding: body, as: UTF8.self) == "email=leo%20lobato&password=a%26b%3Dc")
    }

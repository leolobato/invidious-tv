...
private let swLog = Logger(subsystem: "org.lobato.invidioustv", category: "render")
...
final class MPVSoftwareRenderView: UIView {
    ...
    private let renderQueue = DispatchQueue(label: "org.lobato.invidioustv.mpv.swrender", qos: .userInteractive)

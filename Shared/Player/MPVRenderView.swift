...
private let renderLog = Logger(subsystem: AppIdentity.logSubsystem, category: "render")
...
final class MPVRenderView: UIView {
    ...
    private let renderQueue = DispatchQueue(label: AppIdentity.label("mpv.render"), qos: .userInteractive)

...
private let mpvLog = Logger(subsystem: AppIdentity.logSubsystem, category: "mpv")
...
final class MPVPlayer: @unchecked Sendable {
    ...
    private let commandQueue = DispatchQueue(label: AppIdentity.label("mpv.commands"), qos: .userInitiated)
    ...
    private func startEventLoop() {
        ...
        thread.name = AppIdentity.label("mpv.events")
